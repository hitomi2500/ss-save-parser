...
if (save->DateTime.date().year() > 2500) return NotAHeader; //someone playing Saturn in 26th century? I love you!
if (save->DateTime.date().year() < 1900) return NotAHeader; //now that's too negative
return ParseOk;
}
